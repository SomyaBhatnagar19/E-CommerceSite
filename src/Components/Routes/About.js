...
//       <img src={AboutImage} alt="about-page-img" style={{alignSelf: 'flex-start', image}}/>
//       <p>
      ...
      <div className="row">
        ...
        <div className="col-lg-8">
          <p>
            ...
            the pleasures of the pain, explain the treatment of excepturi of
            the blessed sufferings. I never said will unfold in him receives at
            ...
            of the debts receives the very great importance to us that these
            are consequent to that question is answered, which was selected for
            the fault, it is often one of us, however, have any! Moreover, this
            is often not at once take the hardships of the life of harsh
